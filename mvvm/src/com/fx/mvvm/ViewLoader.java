...
import com.fx.mvvm.internal.viewloader.FxmlViewLoader;
import com.fx.mvvm.internal.viewloader.JavaViewLoader;
import com.fx.mvvm.internal.viewloader.ResourceBundleManager;
...
public class ViewLoader {
     ...
     * 
     * @param viewType
     *            the type of the view that should be loaded.ß
     * @param <ViewType>
     *            the generic type of the View that should be loaded. This type
     *            has to implement {@link de.saxsys.mvvmfx.FxmlView}.
     * @param <ViewModelType>
    ...
    /**
     * load一个自己的实例和对应的ViewModel（无法优先给自己传参）
     * @param cls
     * @return
     */
    public static ViewTuple load(Class cls){
        return fxmlView(cls).load();
    }
}
