 ...
 ******************************************************************************/
package com.fx.mvvm.utils.mapping;

import com.fx.mvvm.utils.mapping.accessorfunctions.*;
...
public class ModelWrapper<M> {
   ...
   */
	...
	public DoubleProperty field(DoubleGetter<M> getter, DoubleSetter<M> setter) {
		final BeanPropertyField<Number, SimpleDoubleProperty> beanPropertyField = new BeanPropertyField<>(
	...
	public DoubleProperty field(String identifier, DoubleGetter<M> getter, DoubleSetter<M> setter) {
		final BeanPropertyField<Number, SimpleDoubleProperty> beanPropertyField =
	...
	public DoubleProperty field(String identifier, DoubleGetter<M> getter, DoubleSetter<M> setter,
			double defaultValue) {
		BeanPropertyField<Number, SimpleDoubleProperty> beanPropertyField = new BeanPropertyField<>(
				getter::apply, (m, number) -> setter.accept(m, number.doubleValue()),
				defaultValue,
				() -> new SimpleDoubleProperty(null, identifier));
		return addIdentified(identifier, beanPropertyField);
	...
	public FloatProperty field(FloatGetter<M> getter, FloatSetter<M> setter) {
		final BeanPropertyField<Number, SimpleFloatProperty> beanPropertyField = new BeanPropertyField<>(
	...
	public FloatProperty field(FloatGetter<M> getter, FloatSetter<M> setter, float defaultValue) {
		BeanPropertyField<Number, SimpleFloatProperty> beanPropertyField = new BeanPropertyField<>(
	...
	public IntegerProperty field(IntGetter<M> getter, IntSetter<M> setter) {
		BeanPropertyField<Number, SimpleIntegerProperty> beanPropertyField = new BeanPropertyField<>(
	...
	public LongProperty field(LongGetter<M> getter, LongSetter<M> setter) {
		BeanPropertyField<Number, SimpleLongProperty> beanPropertyField = new BeanPropertyField<>(
